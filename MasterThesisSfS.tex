...
%% Dedication (optional)
  ...
  \include{tex/misc/Preface}

  % Abstract should not be longer than one page.
  \newpage
  \markboth{Abstract}{Abstract}
  \include{tex/misc/Abstract}
...
\include{tex/chapters/Data_Methods.tex}
\include{tex/chapters/Interpolation}
\include{tex/chapters/ndvi_corr}
\include{tex/chapters/Results.tex}
\include{tex/chapters/Discussion.tex}
\include{tex/chapters/Outlook.tex}

% \include{tex/example/Chapter1}
%%\include{tex/Chapter...}
\include{tex/chapters/Summary}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Bibliography                              %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
