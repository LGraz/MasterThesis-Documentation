...
% \section{Uncertainty Estimation}{
    ...
    Once we have corrected the NDVI using the models described in the previous section, we are left with the problem that not every correction is equally reliable.One such example is illustrated in figure~\ref{fig:step_plot/2017-206_corr.pdf}, where the outer points (labeled as clouds) have a large scatter. Hence, we are interested in a measure of how uncertain an estimate is. 
