...
\section{Non-Parametric Regression}
	...
	\subsection{Smoothing Splines}
		...
		To define Smoothing Splines (SS) as in \cite{cravenSmoothingNoisyData1978}, let $\mathcal F$ be the Sobolev space (i.e., the space of functions of which the second derivative is integrable). Then SS are the unique minimizer of
		\begin{equation}
			\label{eq:ss}
