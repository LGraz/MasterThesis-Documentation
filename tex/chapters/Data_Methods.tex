...
\section{Sentinel 2 Data}{
	...
	%\subsection*{General Information}
		...
		\cite{esaEuropeanSpaceAgency2022} supplies the Scene Classification Layer ({SCL}). It is a model output that for each location assigns the observed pixel to one of 11 SCL-classes (cf. table~\ref{tab:satelite/scl_classes}). 
