...
$P$: a pixel. More formally we see it as a collection of all the observations at the specified location within one season. %That is $P := \left\{P_t | t\text{ is a valid sample time within }\right\}$
