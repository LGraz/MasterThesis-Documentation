...
Instructions and the relevant code needed to reproduce this thesis can be found in the GitHub repository: \\\url{https://github.com/LGraz/MasterThesis-Code} 

To use our results we recommend the R-package: \\\url{https://github.com/LGraz/CorrectTimeSeries } 
